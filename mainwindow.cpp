    ...
    ui(new Ui::MainWindow)
{
   ...
   // this->setWindowFlags(Qt::FramelessWindowHint | windowFlags());//去掉窗口标题栏方式
    ...
    this->setWindowTitle(QString("音视频播放器"));
//    _previewInitParent = ui->widget->parentWidget();
//    _previewInitPoit = ui->widget->pos();
//    _previewInitSize = ui->widget->size();
...
//    ui->pushButton_6->setStyleSheet("QPushButton{border-radius: 5px;color:rgb(0, 0, 0);font: 75 16pt;}"
//                                    "QPushButton:hover{background-color:white; color: black;}"
//                                    "QPushButton:pressed{background-color:rgb(85, 170, 255);}");

//    ui->pushButton_10->setIcon(QIcon(":/icon/maximize_window.png"));
//    ui->pushButton_10->setIconSize(QSize(20,20));
//    ui->pushButton_10->setStyleSheet("QPushButton{border-radius: 5px;color:rgb(0, 0, 0);font: 75 16pt;}"
//                                    "QPushButton:hover{background-color:white; color: black;}"
//                                    "QPushButton:pressed{background-color:rgb(85, 170, 255);}");

//    ui->pushButton_11->setIcon(QIcon(":/icon/minimize_window.png"));
//    ui->pushButton_11->setIconSize(QSize(20,20));
//    ui->pushButton_11->setStyleSheet("QPushButton{border-radius: 5px;color:rgb(0, 0, 0);font: 75 16pt;}"
//                                    "QPushButton:hover{background-color:white; color: black;}"
//                                    "QPushButton:pressed{background-color:rgb(85, 170, 255);}");
...
//    ui->label_4->setStyleSheet("QLabel{border-radius: 10px;color:rgb(0, 0, 0);font: 75 16pt;}");  //标题栏文字说明

    mplayerProcess = new QProcess(this);  //新进程
    mplayerProcess->setProcessChannelMode(QProcess::MergedChannels);

//    ui->label_6->setScaledContents(true);
//    ui->label_6->resize(ui->widget->size());
...
//    ui->pushButton_7->setIconSize(QSize(150,110));  //图标大小
...
void MainWindow::timeDone()  //定时槽函数
{
    ...
    QObject::connect(mplayerProcess,SIGNAL(readyReadStandardOutput()),this,SLOT(back_message_slots()));  //信号函数与槽函数连接
}
...
void MainWindow::on_pushButton_9_clicked()
{
  ...
  if (this->isFullScreen())
      {
          this->showNormal();
          ui->widget->resize(ui->widget->size());
          ui->widget->move( ui->widget->pos());
          this->statusBar()->show();
      }
      else
      {
...
void MainWindow::on_pushButton_5_clicked()
{
    ...
    if(!fileName.isEmpty())
    {
        ...
        const QString mplayerPath("D:/Mplayer/MPlayer for Windows/mplayer.exe");
